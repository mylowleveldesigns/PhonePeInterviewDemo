...
Seperate Managers for Cart, User and Inventory using interfaces.
Interfaces allow different implementation in the future.

MarketPlaceDemo class for sample execution of the program

Demo Functions in marketPlace class -
...
Improvements [Mot done because of short of time]-
Seperate Static Class for validators.
Better handling of concurrency related errors.
...
Should check on the availability of the products before checkout.
Multiple users trying to buy the same product and added to the card.
